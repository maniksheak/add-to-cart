<template>
    <div>
        ...
        <v-row>
            <v-col cols="12">
                <v-row v-show="grid">
                    <v-col v-for="( product, i ) in  products" :key="i" cols="12" lg="3" sm="6">

                        <v-card class="mx-auto pb-3">
                            <v-img :src="product.image" height="275px" cover>
                                <template v-slot:placeholder>
                                    <v-row align="center" class="fill-height  ma-0" justify="center">

                                        <v-progress-circular color="gray lighten-5" indeterminate>
                                        </v-progress-circular>
                                    </v-row>
                                </template>
                            </v-img>
